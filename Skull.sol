...
contract TestSkull is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70 Skull
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 60 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 0 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 9 ether;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("TSkull", "TSkull") {
        _mint(msg.sender, 1 ether); // mint 1 BOMB Skull for initial pools deployment
