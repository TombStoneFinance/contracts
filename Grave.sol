...
contract GraveTest is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 20 ether;
    // Initial distribution for the day 2-5 GRAVE-WETH LP -> GRAVE pool
    uint256 public constant INITIAL_GRAVE_POOL_DISTRIBUTION = 140 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Grave Token Test", "TGRAVE") {
