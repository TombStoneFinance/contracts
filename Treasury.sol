...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x000000000000000000000000000000000000dEaD), // GraveGenesisPool
        address(0x000000000000000000000000000000000000dEaD), // GraveRewardPool
        address(0x000000000000000000000000000000000000dEaD) // Grave token itself
    ];
    ...
    function initialize(
        ...
        maxSupplyContractionPercent = 300; // Upto 3.0% supply for contraction (to burn GRAVE and mint gbond)
